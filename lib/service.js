...
var DEPLOY_WAIT_INTERVAL = 10000;
 ...
 */
Service.prototype.fetchTaskDefinition = function(url) {
  var s3parts = _parseS3Url(this.service.taskDefinitionLocation);
  var s = this;
  return new Promise(function(resolve, reject) {
    ...
    s3.getObject({
      ...
      var taskDef = JSON.parse(data.Body);
...
Service.prototype.registerTaskDefinition = function(version) {
  var s = this;
  return this.fetchTaskDefinition(this.taskDefinitionLocation).then(function(taskDef) {
    return new Promise(function(resolve, reject) {
...
Service.prototype.scaleDown = function() {
  ...
  return new Promise(function(resolve, reject) {
    s.autoScaling.setDesiredCapacity({
      ...
      console.log('Scaled cluster back down (cluster size = ' + s.previousCapacity + ')')
      resolve();
    });
  });
}
...
Service.prototype.isReady = function(version) {
  var deferreds = [
    this.fetchTaskDefinition(this.taskDefinitionLocation),
